...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("Jhhp1s406e");
        question.setLevelid(7);
        question.setQuestionIcon("ec0vXZUmXHGFt6OxjurnmVFurQARqANBcSgaSo9QisdXV0Lfy4");
        question.setQuestion("pMyCzzVQkEyVZAIPdcvfkaMf5qxs04RwJuwOGOSMJnPIvzm45J");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("w1D88BVbNM");
            question.setLevelid(10);
            question.setQuestionIcon("aBhngaOANE7nZerNsF6csK7IhSBwIr31i8vPivYtbeSc4zEzm4");
            question.setQuestion("mGYyB5Ye29E5t0RUZI3gcpke5YXBR9APQUllOAUaV4gd1n2SAP");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "eHUwfLSQJvHmFPcfS8pBrxqvhW8gl5CPKjkZ2mjU6hBWKsF9kBOkqw9TR4vV7wIOi"));
