...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainName("9ddZnCDJAGGNuIEN8pMbNnmzwZGvGgc1lGaY9BRtpKiIHcBR8V");
        useraccessdomain.setDomainDescription("3d1PjCorRzE10gBuQjNj6XuxZ9ZbOqPLfRVrsfxKBjwmKMzebV");
        useraccessdomain.setDomainIcon("7dRtwiHJJtY2rS86Jdz0BVpLTSS7zf0WjNF2waYaoMbxcn8asW");
        useraccessdomain.setDomainHelp("FUWzrZIDnEcMtQwiu4rW2qs8pXB3Pj8SN2vtiO8pcwuhAt2whU");
        ...
        useraccesslevel.setLevelHelp("Ol5qKZFlwwfcpSodzLApfkgjx3ZwWTnbtdy39dvJNiWq8s5NOd");
        useraccesslevel.setLevelDescription("6oDqObMYrewDNfK77zjyiU2K1zJyEIV8ZV7FooYlcBW6OBubkE");
        useraccesslevel.setLevelIcon("AeH9GpS9eckl0LnihoZmVyPATQZjIkbled2cyehSQIAV4IIWBZ");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelName("MbIcqXbP9LdM4qZTaYBKS13YNY2FZMSJYEsV3USZYtH8KCEEL7");
        ...
        user.setUserAccessCode(7121);
        user.setChangePasswordNextLogin(1);
        user.setPasswordAlgo("xid62P0EoWDRGfedQH5kmZxOK9h8kYxRWkeHN3DQAID6KidZht");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1463382490945l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1463382490970l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("HRXZXEeIbnQsJYGeuIz0aM5L9u7yhVBx7PrWbYIyG3ZSjqOjYR");
        Question question = new Question();
        question.setQuestionDetails("5TYfG810b2");
        question.setLevelid(10);
        question.setQuestionIcon("2QGp5vkKm305iKGgSBQ5VFi9Gvc0eFJzAyhO7KZGAL7koFsCQ4");
        question.setQuestion("neD7E3YMZe7GqUkLxxmEBd6msslD6PNIlIiQhDPGhnPXlBWGFH");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("wbbQX3weCwjIVEE5Imbwv1XcsbqahrZPGQ8BRqoVcAeeSkMkW8");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setPassword("4iwkDQ5HzWyYm2RoW1rqvtSNA7xoz9Zx2ea9OzgkZUsnGMCpgc");
        userdata.setOneTimePasswordExpiry(2);
        userdata.setOneTimePassword("O2p65PK9RTHJwJuOQ4kYwVqHdS4G0vhL");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463382491104l));
        userdata.setPassword("lUUYfVALRiMD5lctlvfuDmudNlmFQqKjjfbv3X21ndQJ0yJBqt");
        userdata.setOneTimePasswordExpiry(9);
        userdata.setOneTimePassword("e2ZccZqW5VvxBUS1lSheJrUirug42t3I");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1463382491113l));
        userdata.setUser(user);
        userdata.setLast5Passwords("8PeQfPHBMfCqLXMYKGWb5aaZ6T0NPjbHK7tz15WkeoVJm7PoTL");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 70954));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "pL15ZgL6PslXd8fAv3U8F0OOKAWwPjLJ05GWRvvT3dmUd3hO1ZdE2eSSTZnaRBRdA"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5543));
