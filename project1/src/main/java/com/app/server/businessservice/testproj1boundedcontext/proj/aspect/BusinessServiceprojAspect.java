package com.app.server.businessservice.testproj1boundedcontext.proj.aspect;
...
@Aspect
@Component
public class BusinessServiceprojAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.testproj1boundedcontext.proj..*(..))")
    ...
    public Object aroundfindAll(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object object = null;
        try {
            Log.out.println("PRP317100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
            ...
            businessException.getException("PR", "P", e, runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint);
        } finally {
