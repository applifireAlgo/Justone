package com.app.server.businessservice.justone.justone.aspect;
...
@Aspect
@Component
public class BusinessServicejustoneAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.justone.justone..*(..))")
    ...
    public Object aroundfindAll(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object object = null;
        try {
            Log.out.println("JOJU317100100", runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), joinPoint.getSignature().getDeclaringTypeName() + ":" + joinPoint.getSignature().getName());
            ...
            businessException.getException("JO", "JU", e, runtimeLogInfoHelper.getRequestHeaderBean(), joinPoint);
        } finally {
